...
//
  ...
  event.remove({id: 'metalbarrels:barrels/diamond_to_crystal_barrel'})
...
// Wood to Copper Upgrade
  event.shaped('metalbarrels:wood_to_copper',
    ...
    2: '#minecraft:planks'}).id('metalbarrels:upgrades/wood_to_copper_upgrade')

// Copper to Iron Upgrade
  event.shaped('metalbarrels:copper_to_iron',
    [' 1 ','121',' 1 '], {
    1: '#forge:ingots/iron',
    2: '#forge:ingots/copper'}).id('metalbarrels:upgrades/copper_to_iron_upgrade')

// Iron to Silver Upgrade
  event.shaped('metalbarrels:iron_to_silver',
    [' 1 ','121',' 1 '], {
    1: '#forge:ingots/silver',
    2: '#forge:ingots/iron'}).id('metalbarrels:upgrades/iron_to_silver_upgrade')

// Silver to Gold Upgrade
  event.shaped('metalbarrels:silver_to_gold',
    [' 1 ','121',' 1 '], {
    1: '#forge:ingots/gold',
    2: '#forge:ingots/silver'}).id('metalbarrels:upgrades/silver_to_gold_upgrade')

// Gold to Diamond Upgrade
  event.shaped('metalbarrels:gold_to_diamond',
    [' 1 ','121',' 1 '], {
    1: '#forge:gems/diamond',
    2: '#forge:ingots/gold'}).id('metalbarrels:upgrades/gold_to_diamond_upgrade')

// Diamond to Obsidian Upgrade
  event.shaped('metalbarrels:diamond_to_obsidian',
    [' 1 ','121',' 1 '], {
    1: '#forge:obsidian',
    2: '#forge:gems/diamond'}).id('metalbarrels:upgrades/diamond_to_obsidian_upgrade')

// Obsidian to Netherite Upgrade
  event.shaped('metalbarrels:obsidian_to_netherite',
    [' 1 ','121',' 1 '], {
    1: '#forge:ingots/netherite',
    2: '#forge:obsidian',}).id('metalbarrels:upgrades/obsidian_to_netherite_upgrade')
