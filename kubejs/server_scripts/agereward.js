...
FTBQuestsEvents.customReward('48A96B2C9212C592', event => {
  ...
  event.server.runCommandSilent(`improvedmobs difficulty player ${event.player.username} set 25`) // Start Age 1 at 25
...
FTBQuestsEvents.customReward('3BDF4315261148F8', event => {
  ...
  event.server.runCommandSilent(`improvedmobs difficulty player ${event.player.username} set 50`) // 50 to 75
...
FTBQuestsEvents.customReward('66EB2D3DCD1C6A4F', event => {
  ...
  event.server.runCommandSilent(`improvedmobs difficulty player ${event.player.username} set 100`) // 100 to 150
...
FTBQuestsEvents.customReward('0C65D4EE9C314A07', event => {
  ...
  event.server.runCommandSilent(`improvedmobs difficulty player ${event.player.username} set 200`) // 100 - 250
...
FTBQuestsEvents.customReward('7734F29B02A3CAC7', event => {
  ...
  event.server.runCommandSilent(`improvedmobs difficulty player ${event.player.username} set 300`) // 200 - 250
