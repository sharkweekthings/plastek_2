...
StartupEvents.registry('item', e => {
  ...
  e.create('box_of_adze_head_steel_cast_parts')
  e.create('box_of_boots_plating_steel_cast_parts')
  e.create('box_of_bow_grip_steel_cast_parts')
  e.create('box_of_bow_limb_steel_cast_parts')
  e.create('box_of_broad_axe_head_steel_cast_parts')
  e.create('box_of_broad_blade_steel_cast_parts')
  e.create('box_of_chestplate_plating_steel_cast_parts')
  e.create('box_of_coin_steel_cast_parts')
  e.create('box_of_gear_steel_cast_parts')
  e.create('box_of_gem_steel_cast_parts')
  e.create('box_of_hammer_head_steel_cast_parts')
  e.create('box_of_helmet_plating_steel_cast_parts')
  e.create('box_of_large_plate_steel_cast_parts')
  e.create('box_of_leggings_plating_steel_cast_parts')
  e.create('box_of_maille_steel_cast_parts')
  e.create('box_of_pick_head_steel_cast_parts')
  e.create('box_of_repair_kit_steel_cast_parts')
  e.create('box_of_rod_steel_cast_parts')
  // e.create('box_of_round_plate_steel_cast_parts')
  e.create('box_of_small_axe_head_steel_cast_parts')
  e.create('box_of_small_blade_steel_cast_parts')
  e.create('box_of_tool_binding_steel_cast_parts')
  e.create('box_of_tool_handle_steel_cast_parts')
  ...
  e.create('tough_handle_steel_cast').tag('tconstruct:casts/multi_use').tag('tconstruct:casts/multi_use/tough_handle')
